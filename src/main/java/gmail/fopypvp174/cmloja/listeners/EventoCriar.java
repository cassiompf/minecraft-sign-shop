...
public final class EventoCriar implements Listener {
    ...
    private void createSignLoja(Player jogador, String[] linhas, org.bukkit.block.Sign placa)
        ...
        if (!linhas[0].equals(this.plugin.getMessageConfig().message("placa.nomeLoja"))) {
